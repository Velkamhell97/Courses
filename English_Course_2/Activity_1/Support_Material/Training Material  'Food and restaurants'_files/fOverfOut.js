...
function fOverNav(e) {
    var overbtnNav = Display.get("ventanaActividades.botonAdelante");
...
function fOverNavAtras(e) {
    var overbtnNavAtras = Display.get("ventanaActividades.botonAtras");
    overbtnNavAtras.play("sobre");
}
 
function fOutNavAtras(e) {
    var overbtnNavAtras = Display.get("ventanaActividades.botonAtras");
    overbtnNavAtras.play("sobreOver");
}
