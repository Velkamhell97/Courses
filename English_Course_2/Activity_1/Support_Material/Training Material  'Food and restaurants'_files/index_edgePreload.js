...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "js/CodeCraft.min.js", user: true },
      { load: "js/Main.js", user: true },
      { load: "js/fContenido1.js", user: true },
      { load: "js/fContenido2.js", user: true },
      { load: "js/fContenido3.js", user: true },
      { load: "js/fContenido4.js", user: true },
      { load: "js/fContenido5.js", user: true },
      { load: "js/fContenido6.js", user: true },
      { load: "js/fOverfOut.js", user: true },
      { load: "js/fOverfOutSubmenu.js", user: true },
      { load: "js/ArrastrarUnoaMuchos.js", user: true },
      { load: "js/ArrastrarUnoaMuchosC6P1.js", user: true },
      { load: "js/ArrastrarUnoaMuchosC6P2.js", user: true },
      { load: "js/ArrastrarUnoaMuchosC6P2b.js", user: true },
      { load: "js/ArrastrarUnoaMuchosC6P3.js", user: true },
      { load: "js/ArrastrarUnoaUno.js", user: true },
      { load: "js/ArrastrarUnoaUnoCont4Pag7.js", user: true },
      { load: "js/falsoVerdadero.js", user: true },
      { load: "js/falsoVerdaderoCont5.js", user: true },
      { load: "js/validacionCampos.js", user: true },
      { load: "js/juegoListaSelect.js", user: true },
      { load: "js/variables.js", user: true },
      { load: "index_edge.js"},
...
var plSTF="none",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="1000px",plHeight="640px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['250px', '258px','500px','124px','auto', 'auto'],
